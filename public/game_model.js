function Player(x, y, aim_x = 0.01, aim_y = 0.01) {
	...
	this.aim_direction = createVector(aim_x, aim_y)
	...
	this.update = function() {
		...
		this.pos.limit(field_radius-this.attr.radius)
...
function Projectile(pos, vel, r, max_spd) {
	...
	this.update = function() {
		...
		if (this.pos.mag() > field_radius) this.alive = 0;
	}
